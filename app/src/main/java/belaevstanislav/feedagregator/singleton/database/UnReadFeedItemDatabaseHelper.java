...
public class UnReadFeedItemDatabaseHelper extends SQLiteOpenHelper {
    ...
    public UnReadFeedItemDatabaseHelper(Context context) {
    ...
    public long insertWithoutCaching(FeedItemCore core) {
    ...
    public long insertWithCaching(long id, FeedItem feedItem) {
        SQLiteDatabase database = getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(KEY_TABLE_ID, id);
    ...
    public int delete(long id) {
        ...
        return database.delete(COMMON_INFORMATION_TABLE_NAME, KEY_TABLE_ID + " = ?", new String[]{String.valueOf(id)});
    }
